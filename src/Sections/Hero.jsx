  ...
  return (
    ...
    >
      ...
      >
        ...
        <p className="font-montserrat text-slate-gray text-lg mt-10 mb-16
        sm:max-w-sm">
        ...
        <div className="flex justify-start items-start flex-wrap w-full mt-20 gap-16">
          {statistics.map((stat) => (
            <div key={stat.label}>
              ...
              <p className="leading-7 font-montserrat text-slate-gray text-end pt-1">{stat.label}</p>
            </div>
          ))}
        </div>
      </div>
